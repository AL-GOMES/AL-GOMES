...
(function () {
  ...
  // Note : les logs sont capturés en continu via le wrap console.* ci-dessus
  // et accessibles via window.AlgomesLog.getAll() (panneau admin). Plus de
  // bouton flottant « DÉMARRER LE LOG » — il ne servait qu'à délimiter une
  // session pour l'export ; l'admin a son propre export de tous les logs.
